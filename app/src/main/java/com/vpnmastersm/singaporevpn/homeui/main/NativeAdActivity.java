...
public class NativeAdActivity extends Activity {
    ...
    private Button refresh,close,disconnect;
    private CheckBox startVideoAdsMuted;
    private TextView videoStatus,serverName;
    private UnifiedNativeAd nativeAd;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nativeadfullscreen);
        ...
        mConfig = new AutoConfigVPN(getApplicationContext());
        vpnServerHelper = new VPNServerHelper(getApplicationContext(), mConfig);

        serverName = findViewById(R.id.serverName);

        SharedPreferences sharedpreferences = getApplicationContext().getSharedPreferences("VPN", Context.MODE_PRIVATE);
        String servernames = sharedpreferences.getString("ServerName", "No Server Found");

        serverName.setText(servernames);
        Animation anim = new AlphaAnimation(0.0f, 1.0f);
        anim.setDuration(50); //You can manage the blinking time with this parameter
        anim.setStartOffset(20);
        anim.setRepeatMode(Animation.REVERSE);
        anim.setRepeatCount(Animation.INFINITE);
       // serverName.startAnimation(anim);
        ratingBar2 = findViewById(R.id.ratingBar2);
     //   DrawableCompat.setTint(ratingBar2.getProgressDrawable(), Color.YELLOW);
